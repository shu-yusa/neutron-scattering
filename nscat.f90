...
!----------------------------------------------------------------------!
      ...
      real(kind=8),  parameter, private :: r0 = 1.2d0
      real(kind=8),  parameter :: dx = 0.006d0
      real(kind=8),  parameter :: rmax = 15.0d0
      real(kind=8),  parameter :: Amass = 40.0d0
      real(kind=8),  parameter :: Mn = 938.0d0
      real(kind=8),  parameter :: hbarc = 197.329d0
      real(kind=8),  parameter :: E = 10.0d0
      real(kind=8),  parameter :: V0 = 50.0d0, ALPHA = 0.63d0
      real(kind=8),  parameter :: rmass=Mn * Amass / (1.0d0 + Amass) 
      real(kind=8),  parameter :: k = sqrt(2.0d0 * E * rmass) / hbarc
      real(kind=8),  parameter :: Rn = r0 * Amass ** (1.0d0/3.0d0)
      end module
!======================================================================!
      program main
      use Com_var, only : Lc
...
!----------------------------------------------------------------------!
      ...
      implicit none
      integer, intent(in) :: L
      real(kind=8), intent(out) :: a, b, s
      real(kind=8) :: y(3), x, ya
...
!----------------------------------------------------------------------!
      ...
      real(kind=8), intent(inout) :: y(3)
      real(kind=8), external :: kk
      real(kind=8), parameter :: wh=dx*dx/12.0d0
      real(kind=8)  :: ynm2, ynm1
...
!----------------------------------------------------------------------!
      ...
      implicit none
      integer :: L
      real(kind=8), intent(out) :: delta(0:Lc) 
      real(kind=8), external :: jL, nL
      real(kind=8)  :: s, a, b, arg
...
!----------------------------------------------------------------------!
      ...
      implicit none
      integer :: L
      real(kind=8), intent(in) :: delta(0:Lc), t
      real(kind=8), external :: PL
      real(kind=8) :: ds
...
!----------------------------------------------------------------------!
      ...
      implicit none
      integer :: L
      real(kind=8), intent(in)  :: delta(0:Lc)
      real(kind=8), intent(out) :: tsig
...
!----------------------------------------------------------------------!
      ...
      real(kind=8) :: t, tsig
      real(kind=8), intent(in) :: delta(0:Lc)
      real(kind=8), external :: dsigma
      real(kind=8),  parameter :: PI=3.1415926535897932d0
      character(len=25), parameter :: FM1='(2x,i4,3x,a,5x,f9.4,a)'
